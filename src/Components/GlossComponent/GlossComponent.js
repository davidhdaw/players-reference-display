...
if (line.cutType && line.cutType !== 'none') {
    ...
    // console.log(relevantNotes[0].words[relevantNotes[0].words.length - 1])
    console.log()
return (
    <p className={lineType + ' line-container'} >
          ...
          <span className='beforeNote1'>
            ...
            <span class="above">{content.slice((relevantNotes[0].words[0]), (relevantNotes[0].words[relevantNotes[0].words.length - 1] + 1)).join(' ')}
            <span class="belowgloss">{relevantNotes[0].synonym}</span>
          </span>
...
return (
    <p className={lineType + ' line-container'} >
          <span className='lineContent'>
            ...
            <span class="above">{content.slice((relevantNotes[1].words[0]), (relevantNotes[1].words[relevantNotes[1].words.length - 1] + 1)).join(' ')}
                <span class="belowgloss">{relevantNotes[1].synonym}</span>
            </span>
...
return (
    <p className={lineType + ' line-container'} >
          <span className='lineContent'>
            ...
            <span class="above">{content.slice((relevantNotes[2].words[0]), (relevantNotes[2].words[relevantNotes[2].words.length - 1] + 1)).join(' ')}
                <span class="belowgloss">{relevantNotes[2].synonym}</span>
            </span>
